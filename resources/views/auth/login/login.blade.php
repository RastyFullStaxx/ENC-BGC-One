...
<div class="flex items-center justify-center min-h-screen bg-gray-50 px-2">
    <div class="bg-white shadow-md rounded-lg w-full max-w-[448px] p-16 sm:p-16">
        <!-- Logo -->
        ...
        <a href="{{ route('login.index') }}" 
            class="flex items-center text-m text-gray-500 hover:text-gray-700 hover:underline transition-colors duration-150 space-x-1"
        ...
        <form action="{{ route('user.dashboard') }}" method="GET" class="space-y-4">
            ...
            <!-- Sign In Button -->
            <button type="submit"
                class="w-full bg-blue-900 text-white py-2.5 rounded-md hover:bg-blue-800 transition-colors font-medium">
                Sign In
            </button>
        </form>
